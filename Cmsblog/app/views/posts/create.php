...
<div class="container-fluid">
  <div class="container col-md-8 p-2 shadow-inset rounded">
    <div class="shadow-soft rounded p-2">
      <h6 class="text-center my-3 display-4">Create New Post</h6>
   <!-- Create Post Form -->
      <? flash("imgNull"); ?>

    <form action="<?php  echo URLROOT.'post/create'; ?>" class="p-2" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        ?>
        " id="validationServer02" required name="title">
        <div class="<?php
   ...
   <div class="form-group">
    ...
    <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="categoryType">
      ...
      <div class="form-group">
        ...
        ?>
        " id="validationServer03" required name="sometext">
        <div class="<?php
      ...
      <div class="form-group">
        ...
        ?>
        " id="validationServer03" required name="content" rows="10"></textarea>
        <div class="<?php
